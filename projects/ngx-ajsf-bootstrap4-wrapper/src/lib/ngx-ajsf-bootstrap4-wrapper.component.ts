...
import {NgxJsonSchemaFormService, addClasses, inArray} from 'ngx-ajsf-wrapper';

@Component({
  selector: 'ngx-ajsf-bootstrap4-wrapper',
  templateUrl: './ngx-ajsf-bootstrap4-wrapper.component.html',
  styleUrls: ["./ngx-ajsf-bootstrap4-wrapper.component.scss"]
})
export class NgxAjsfBootstrap4WrapperComponent implements OnInit {
